...
@section('titulo')
<h2>Banner <span>Nova Imagem</span></h2>
@stop
@section('cabecalho')
<ul class="page-breadcrumb">
    ...
    <li><a href="javascript:void(0)">Nova Imagem</a></li>
</ul>
@stop
...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-body">
                {!! Form::open(array('route' => array('banner.imagem.store', $banner->id), 'method'=>'post', 'files'=>'true')) !!}

                @include('backend/banner/imagem/form')
