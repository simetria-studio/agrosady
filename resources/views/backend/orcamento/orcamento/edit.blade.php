...
@section('titulo')
<h2>Orçamento <span>Editar Solicitação de Orçamento</span></h2>
@stop
@section('cabecalho')
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="javascript:void(0)">Editar Orçamento</a>
    </li>
</ul>
@stop
...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-body">
                {!! Form::model($orcamento, ['route'=>['operacao.orcamento.update', $orcamento->id]]) !!}
