...
@section('titulo')
<h2>Agenda de Eventos <span>Editar Evento {{$evento->titulo}}</span></h2>
@stop
@section('cabecalho')
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="javascript:void(0)">Editar Eventos {{$evento->titulo}}</a>
    </li>
</ul>
@stop
...
<div class="row mt-20">
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-body">
                {!! Form::model($evento, ['route'=>['galeria-evento.update', $evento->id], 'files'=>'true']) !!}
