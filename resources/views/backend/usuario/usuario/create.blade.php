...
@section('titulo')
<h2>Usuário <span>Novo Administrador</span></h2>
@stop
...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="javascript:void(0)">Novo Administrador </a>
    </li>
</ul>
@stop
...
<div class="row  mt-20">
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-body">
                {!! Form::open(array('route' => 'usuario.usuario.store', 'files'=>'true')) !!}

                @include('backend/usuario/usuario/form-criar')

                @include('backend/usuario/permissao/form-criar')
