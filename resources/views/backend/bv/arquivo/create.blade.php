...
@section('titulo')
<h2>Biblioteca Virtual <span>Novo Arquivo</span></h2>
@stop
@section('cabecalho')
...
<div class="row mt-20">
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-body">
                {!! Form::open(array('route' => ['bv.arquivo.store', 'id'=>$pasta->id], 'method'=>'post', 'files'=>true)) !!}

                @include('backend/bv/arquivo/form')
