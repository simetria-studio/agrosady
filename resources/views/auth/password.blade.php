        ...
        <div id="wrap" class="animsition">
            <div class="page page-core page-login">
                ...
                <div class="container w-420 p-15 bg-white mt-40 text-center">
                    ...
                    <form method="POST" action="{{ route('enviar-resetar-senha-email') }}" name="form" class="form-validation mt-20">
                        {!! csrf_field() !!}
                        <p class="help-block text-left">
                            Digite seu email para receber o link de resetar a sua senha.
                        </p>

                        <div class="form-group">
                            <input type="email" placeholder="E-mail" name="email" value="{{ old('email') }}" class="form-control underline-input pl-10 pr-10">
                        </div>
